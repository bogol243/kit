...
<div class="panel">
    ...
    <div class="panel-body">
        ...
        <ul class="nav nav-tabs">
            <li class="active"><a href="#reasons" data-toggle="tab" aria-expanded="true">Причины простоя</a></li>
        ...
        <div class="tab-content">
            <div class="tab-pane fade active in" id="reasons" style="padding-top: 20px;">
                dsds
            </div>
